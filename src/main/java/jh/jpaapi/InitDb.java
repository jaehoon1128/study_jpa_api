...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1(){
            ...
            Book book1 = getBook("JPA1 Book", 100000, 100);
            em.persist(book1);

            Book book2 = getBook("JPA2 Book", 200000, 200);
            em.persist(book2);
        ...
        public void dbInit2(){
            ...
            Book book1 = getBook("Spring1 Book", 200000, 100);
            em.persist(book1);

            Book book2 = getBook("Spring2 Book", 400000, 200);
            em.persist(book2);
